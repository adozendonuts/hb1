"""
Deans bot for the Halite II competition.
"""
# .\halite.exe -q -d "160 160" -t "python MyBot.py" "python MyBot.py" -r
    ...
    for ship in game_map.get_me().all_ships():
        ...
        for planet in game_map.all_planets():
            ...
            if ship.can_dock(planet):
                ...
                navigate_command = ship.navigate(ship.closest_point_to(planet), game_map, speed=hlt.constants.MAX_SPEED/2, ignore_ships=False)
